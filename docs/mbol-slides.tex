...
\begin{itemize}
\item Add more syntax (e.g., boldface for vectors)
\item Eliminate any need for c++ coding, constants setup through files
\item Type-checking a possibly ambiguous grammar is difficult and needs work
\item More back-ends, currently only CPLEX
\item Possibly more front-ends
\item Make this tool tivially easy to install and use
\end{itemize}
}
